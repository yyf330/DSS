...
#ifndef _BESENCRYPT_H
#define	_BESENCRYPT_H
...
public:
     ...
     */
    static bool Decrypt(string instr, BesEncrypt::BesDecryptType type, string& outlic, string &output, string disksn, string disksize, LicenseMode mode);
     ...
     *      授权值
     */
    static string GetLicense(BesEncrypt::LicenseType type);
     ...
     *      授权值
     */
    static string GetLicense(BesEncrypt::LicenseType type, string &outlic);
     ...
     *      授权值
     */
    static string GetLicense(string input, BesEncrypt::LicenseType type, string disksn, string disksize, string &outlic);
...
private:
     ...
     *      授权模式
     */
    static BesEncrypt::LicenseMode GetLicenseModeWithType(LicenseType type);
     ...
     *      时间字符串
     */
    static string GetTimeString(BesEncrypt::TimeFormat format);
     ...
     *      时间字符串
     */
    static string GetTimeString(time_t time, BesEncrypt::TimeFormat format);
     ...
     *      时间字符串
     */
    static string GetTimeString(struct tm *tmptr, BesEncrypt::TimeFormat format);
     ...
     *      日期格式字符串
     */
    static string GetTimeFormatString(BesEncrypt::TimeFormat format);
